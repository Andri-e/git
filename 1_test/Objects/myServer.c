...
static void powerlinkNode2(UA_Server *server)
{
   ...
   UA_DataValue drasl = 1;
    dtAttr.value = drasl;                                          // For Variables used as InstanceDeclarations, the value is vendor-specific; otherwise it shall represent the value described in the text.
